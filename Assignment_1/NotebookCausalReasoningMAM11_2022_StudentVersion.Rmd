...
treatment <- as.numeric(rhc.selected$treatment.swang==1)  ###?????? this is not correct, not sure why?????
greedymatch <- Match(Tr=treatment, M=1,X=rhc.selected, replace=FALSE) 
...
# => What is inside X?
print('Inside X there is the list containing the variables we wish to match on.')
#calling X to show more details of the values
print("===================================================")
```
...
#answer: who the treated are
greedymatch$index.control # => What do you think this is?
#answer: who the controls are
print("===================================================")
```
...
print("untreated. the index = length gives us the last treated person in the list, when our index exceeds the list length it continues with the people where treated = 0") ## I am 99.9% sure of this but Rstudio is a bitch so it's hard to check
print("===================================================")
```
...
print("This overlap makes sense, since we applied stratification methods. I assume anyways???")
print("===================================================")
```
...
print("I don't know if this is the correct way to do it.")
