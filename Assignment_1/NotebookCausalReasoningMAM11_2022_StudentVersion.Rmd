...
print(" 'replace=FALSE' means that the order of matches matters as they will be founded in the same way the data are ordered so this introduce more bias.")
# => What is inside X?
print('Inside X there is the list containing the variables we wish to match on.')
X    #calling X to show more details of the values
print("===================================================")
```
...
y_con <-  matched$outcome.died[matched$treatment==1]
print("===================================================")
```
