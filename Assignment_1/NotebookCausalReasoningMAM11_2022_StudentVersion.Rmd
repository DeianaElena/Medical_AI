...
# print("===================================================")
mcnemar.test(matrix(c(955,531,336,362 ),2,2)) # => Complete the command by filling the a, b, c, and d numbers in the correct order.
...
print("I don't know if this is the correct way to do it.")     ################### CHECK AGAIN #################
...
# => complete the command
mydata <- prs_df
treatment <- rhc.selected$treatment.swang==1
...
print("===================================================")
# => Complete the command
mcnemar.test(matrix(c(362,336,531,955),2,2)) 
# => Is the p-value less than 0.05? What does this result mean?
...
print("The odds ratio of treatment is 1.47")                ################### CHECK AGAIN, same as 1st #################
```
...
print("The odds ratio of treatment is now ~ 1.25")              ################### CHECK AGAIN, same as 1st ###############
print("===================================================")
```
...
#2. Compare the results to those you obtained by matching
