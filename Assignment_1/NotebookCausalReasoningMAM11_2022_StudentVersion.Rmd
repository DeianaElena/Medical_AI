...
#density hist
par(mfrow=c(2,1))
hist(gotTreatment, main='Treatment group', xlab='Propensity Score', ylim=c(0,2), col='darkblue', 
     prob = TRUE)   #shows density instead of frequency
lines(density(gotTreatment),
      lwd = 2,
      col = "orange")

hist(gotNoTreatment, main='Control group', xlab='Propensity Score', ylim=c(4,0), col='red', 
     prob = TRUE)   #shows density instead of frequency
...
print("This overlap is almost everywhere. Although there is poor overlap on the high propensity score (right tail), the positivity assumption is still reasonable.")   
...
print("The odds ratio of treatment is 1.296")          ################### CHECK THIS #################        
```
...
print("The odds ratio of treatment is now 1.312.")        ######### CHECK THIS #################      
print("===================================================")
```
...
print('When comparing the results obtain previously with the one with a random forest method, we can see that we obtain poor overlap for high propensity scores where we only have subjects without treatment.')


######### CHECK THIS perhaps we can use MAE? ################# 
...
print("We prefer the approach that uses logistic regression for different reasons:
      ...
      3. It is easier to implement therefore more used so more documentation and explanation can be found.")         
