...
==> Student names: Elena Deiana, Ramon Cremers
==> Student numbers: 14110822, 14090945
# Open part
...
par(mfrow=c(2,1))
hist(gotTreatment, main='Population with treatment', xlab='Propensity Score', ylim=c(0,650), col='darkblue')
hist(gotNoTreatment, main='Population without treatment', xlab='Propensity Score', ylim=c(650,0), col='red')
# => What do you think about the overlap? 
print("This overlap is almost everywhere. This is expected, since we applied stratification methods.")   ################### CHECK   AGAIN ?????????? #################
print("===================================================")
```
...
par(mfrow=c(2,1))
hist(logitTreatment, main='Population with treatment', xlab='Log-odds of Propensity Score', xlim=c(-5,5), ylim=c(0,650), col='darkblue')
hist(logitNoTreatment, main='Population without treatment', xlab='Log-odds of Propensity Score', xlim=c(-5,5),ylim=c(650,0), col='red')
#What do you think about the overlap?
print("There is good overlap almost everywhere so the positivity assumption is reasonable.")     


################### CHECK AGAIN, shouldn't we have density instead of frequency? #################
...
print("The difference in the means before and after ....")          ################### CHECK THIS #################
print("===================================================")
```
...
par(mfrow=c(2,1))
hist(gotTreatment2, main='Population with treatment', xlab ='Propensity Score', ylim=c(0,650), col='darkblue')
hist(gotNoTreatment2, main='Population without treatment', xlab ='Propensity Score', ylim=c(650,0), col='red')
```
```{r}
